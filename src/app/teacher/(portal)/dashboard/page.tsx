      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid gap-3.5" style={{ gridTemplateColumns: "repeat(3,1fr)" }}>
          {Array.from({ length: 3 }).map((_, i) => (
            <div
              key={i}
              className="flex min-h-[160px] flex-col gap-2 rounded-[18px] p-[18px]"
              style={{
        ...
        <div className="grid gap-2.5" style={{ gridTemplateColumns: "repeat(5,1fr)" }}>
          {Array.from({ length: 5 }).map((_, i) => (
            <div
              key={i}
              className="flex flex-col items-center gap-1.5 rounded-[14px] px-3 py-3.5"
              style={{
                background: "rgba(255,255,255,.04)",
        ...
        <div>
          ...
          <div className="mb-4 flex gap-1.5">
            {Array.from({ length: 7 }).map((_, i) => (
              <div
                key={i}
                className="flex-1 rounded-[11px] px-1 py-2"
                style={{
                  background: "rgba(255,255,255,.04)",
                  border: "1px solid rgba(255,255,255,.07)",
                }}
              >
                ...
                <Skeleton className="mx-auto mt-1.5 h-4 w-5" />
                <Skeleton className="mt-2 h-3 w-full rounded-[6px]" />
              </div>
            ))}
          </div>
